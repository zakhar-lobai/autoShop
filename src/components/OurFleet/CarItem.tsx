                    ...
                    {cardata.cars.map((car, index) => (
                        <div key={index} className='flex flex-col md:flex-row w-full bg-box-grey'>
                            ...
                            <div className='w-full pt-10 md:w-16per md:pt-30 pl-15 pr-15 pb-30 md:pl-0'>
                                ...
                                {/* Car Page Button */}
                                <Link to={car.pageUrl} className='border border-white w-full py-20 inline-block mb-20 transition duration-300 ease-in-out md:mb-0 hover:bg-yellow hover:border-yellow hover:color-base'>
                                    <button className='text-white text-base font-bold '>Find out more</button>
                                </Link>

                                {/* Book Car Button */}
                                <Link to={car.book} className='bg-yellow color-base md:mt-12 w-full py-20 inline-block transition duration-300 ease-in-out hover:bg-btn-hover hover:border-yellow hover:color-base'>
